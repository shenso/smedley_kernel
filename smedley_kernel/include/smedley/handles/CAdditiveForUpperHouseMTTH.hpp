#ifndef HANDLES_CADDITIVEFORUPPERHOUSEMTTH_HPP_
#define HANDLES_CADDITIVEFORUPPERHOUSEMTTH_HPP_
...
struct CAdditiveForUpperHouseMTTH
{
	void **vftable;
	uint8_t field1_0x4;
	uint8_t field2_0x5;
...
#endif // HANDLES_CADDITIVEFORUPPERHOUSEMTTH_HPP_
