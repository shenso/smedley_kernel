#ifndef HANDLES_CPROVINCEMODIFIER_HPP_
#define HANDLES_CPROVINCEMODIFIER_HPP_
...
struct CProvinceModifier
{
	void **vtable;
	uint8_t field1_0x4;
	CModifier * * maybeAppliedModifiers;
	uint8_t field3_0x9;
	uint8_t field4_0xa;
	uint8_t field5_0xb;
	uint8_t field6_0xc;
...
#endif // HANDLES_CPROVINCEMODIFIER_HPP_
