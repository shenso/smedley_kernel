#ifndef HANDLES_CUNIQUEUNITNAMEINTERNAL_HPP_
#define HANDLES_CUNIQUEUNITNAMEINTERNAL_HPP_
...
struct CUniqueUnitNameInternal
{
	void **vftable;
	uint8_t field1_0x4;
	uint8_t field2_0x5;
...
#endif // HANDLES_CUNIQUEUNITNAMEINTERNAL_HPP_
